...
public class DecorationServiceProviderDetails extends AppCompatActivity {
    Button submit_request_bt;
    TextView provider_name_tv, provider_address_tv, provider_details_tv;
    private final String service_name = "Decoration Service";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_decoration_service_provider_details);
        ...
        submit_request_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DecorationServiceProviderDetails.this, CustomerOrderInfo.class);
