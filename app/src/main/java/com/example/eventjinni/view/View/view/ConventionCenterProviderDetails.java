...
public class ConventionCenterProviderDetails extends AppCompatActivity {
    Button submit_request_bt;
    TextView provider_name_tv, provider_address_tv, provider_details_tv;
    private final String service_name = "Convention Center Service";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_convention_center_provider_details);
        ...
        submit_request_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ConventionCenterProviderDetails.this, CustomerOrderInfo.class);
